        ...
        return declare([OnDemandGrid, Selection, selector], {
            ...
            columns: {
                ...
                name: {
                    ...
                    renderCell: function (row, value, node, options) {
                        //var content = [];
                        //content.push('<span title="Dataset count: ' + row.datasetCount + '" >' + row.name + '</span>');
                        //content.push('<div style="display:none;float:right;">');
                        //content.push('<button class="dsAdd" name="add" type="button" title="Add Datasets to Tray" onclick="app.allSearchResults.allSearchesList.addAllToTray(' + row.id + ');"/>');
                        //content.push('<button class="dsSave" name="save" type="button" title="Save search" onclick="app.allSearchResults.allSearchesList.saveSearch(' + row.id + ');"/>');
                        //content.push('<button class="dsRemove" name="remove" type="button" title="Remove search" onclick="app.allSearchResults.allSearchesList.deleteSearchClick(' + row.id + ');"/>');
                        //content.push('</div>');
                        ...
                        var buttonsDiv = domConstruct.create("span",
                           {
                               title: "Dataset count: " + row.datasetCount,
                               innerHTML: row.name
                           },
                           cellDiv
                       );
